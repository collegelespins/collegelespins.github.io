...
const FleursDuMal: Oeuvre = new Oeuvre("Les Fleurs du Mal", Baudelaire, XIXeme, poesie, new Date(1857,5,21));
const Fleurs_ennemi = new Texte(FleursDuMal,
    "L'Ennemi", sonnet,
    `<pre>Ma jeunesse ne fut qu’un ténébreux orage,
...
const Fleurs_albatros = new Texte(FleursDuMal,
    "L'Albatros", poesie,
    `<pre>Souvent, pour s’amuser, les hommes d’équipage
...
const Fleurs_passante = new Texte(FleursDuMal,
    "À une passante", sonnet,
    `<pre>La rue assourdissante autour de moi hurlait.
...
const Fleurs_parfum = new Texte(FleursDuMal,
    "Parfum exotique", sonnet,
    `<pre>Quand, les deux yeux fermés, en un soir chaud d'automne,
...
const Fleurs_serpent = new Texte(FleursDuMal,
    "Le Serpent qui danse", poesie,
    `<pre>Que j'aime voir, chère indolente,
...
const Fleurs_invit = new Texte(FleursDuMal,
    "L'Invitation au voyage", poesie,
    `<pre>Mon enfant, ma sœur,
    Songe à la douceur
...
const Fleurs_ciels = new Texte(FleursDuMal,
    "Ciel Brouillé", sonnet,
    `<pre>On dirait ton regard d'une vapeur couvert ;
...
const Malade_1a = new Texte(MaladeImaginaire, "Le Malade Imaginaire, Acte I, scène 5", scene,
    `<b>ARGAN, ANGÉLIQUE, TOINETTE.</b>
...
const Malade_1b = new Texte(MaladeImaginaire,
    "Le Malade Imaginaire, Acte I, scène 9", scene,
    `<b>MONSIEUR DE BONNEFOI, BÉLINE, ARGAN.</b>
...
const Malade_2b = new Texte(MaladeImaginaire,
    "Le Malade Imaginaire, Acte II, scène 6", scene,
    `<b>MONSIEUR DIAFOIRUS, Thomas Diafoirus, ARGAN, ANGÉLIQUE, CLÉANTE, TOINETTE, LAQUAIS.</b>
...
const Malade_3a = new Texte(MaladeImaginaire,
    "Le Malade Imaginaire, Acte III, scène 18", scene,
    `<b>BÉLINE ; ARGAN, étendu dans sa chaise ; TOINETTE.</b>
...
const Malade_3b = new Texte(MaladeImaginaire,
    "Le Malade Imaginaire, Acte III, scènes 22 et 23 ", epilogue, 
    `    <b>ARGAN, BÉRALDE, ANGÉLIQUE, CLÉANTE, TOINETTE.</b>
...
const Caractere_1 = new Texte(Caracteres, "Les Caractères, Ménalque", essai,
    `<pre>¶Ménalque descend son escalier, ouvre sa porte pour sortir, il la referme: il s’aperçoit 
...
const Caractere_2 = new Texte(Caracteres, "Les Caractères, Irène", conte_philosophique,
    `<pre>¶Irène se transporte à grands frais en Epidaure, voit Esculape dans son temple, et le 
...
const Caractere_4 = new Texte(Caracteres, "Les Caractères, Les enfants", essai,
    `<pre>¶Les enfants sont hautains, dédaigneux, colères, envieux, curieux, intéressés, paresseux, 
...
const Caractere_5 = new Texte(Caracteres,
    "Les Caractères, Les vieillards", essai,
    `<pre>¶Les haines sont si longues et si opiniâtrées, que le plus grand signe de mort dans un 
...
const Voyage_1 = new Texte(VoyageCentreTerre,
    "Chapitre 1, Le savant", incipit,
    `<pre>
...
40  cendante, par le professeur Otto Lidenbrock, grand in-folio avec planches, qui cependant 
    ...
    const Voyage_2 = new Texte(VoyageCentreTerre,
    "Chapitre 7, L'élève", chapitre,
    `<pre>
...
45  — Non, dis-je enfin, plus bas ! »
    ...
    const Voyage_3 = new Texte(VoyageCentreTerre,
    "Chapitre 11, Le guide", chapitre,
    `<pre>
...
50  « Un fameux homme ! s’écria mon oncle ; mais il ne s’attend guère au merveilleux rôle 
    ...
    const Voyage_4 = new Texte(VoyageCentreTerre,
    "Chapitre 13, L'Hospitalité", chapitre,
    `<pre>
...
65  pus enfin me blottir dans ma couche de fourrage.
    ...
    const Voyage_5 = new Texte(VoyageCentreTerre,
    "Chapitre 28, La folie", chapitre,
    `<pre>
...
55      Où me conduisit cette course insensée ? Je l’ignorerai toujours. Après plusieurs heures, 
    ...
    const Voyage_6 = new Texte(VoyageCentreTerre,
    "Chapitre 30, La forêt", chapitre,
    `<pre>
...
50  africaine.
    ...
    const Voyage_7 = new Texte(VoyageCentreTerre,
    "Chapitre 33, Les monstres", chapitre,
    `<pre>
...
70  ses contorsions s’apaisent, et ce long tronçon de serpent s’étend comme une masse 
    ...
    const Voyage_8 = new Texte(VoyageCentreTerre,
    "Chapitre 39, Le berger", chapitre,
    `<pre>
...
55  subit dans certains cauchemars. Instinctivement, nous revenions vers la mer 
    ...
    const Voyage_9 = new Texte(VoyageCentreTerre,
    "Chapitre 44, Les volcans", chapitre,
    `<pre>
...
const Voyage_10 = new Texte(VoyageCentreTerre,
    "Chapitre 45, La boussole", epilogue,
    `<pre>
