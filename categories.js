...
class Genre extends DocInterne {
    constructor(nom, definition, refs) {
...
class Auteur extends DocInterne {
    constructor(nom, epoque, naiss, deces, plume, bio = "", vraiNom = "") {
        super("Auteur", nom);
        this.epoque = epoque;
        this.naiss = naiss;
        this.deces = deces;
...
class Oeuvre extends DocInterne {
    constructor(titre, auteur, Epoque, genre, publication, resume = "") {
        super("Œuvre", titre);
        this.titre = titre;
        this.auteur = auteur;
        this.Epoque = Epoque;
...
class Texte extends DocInterne {
    constructor(oeuvre, titre, genre, texte = "", explication = "") {
