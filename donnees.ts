...
const figures: FigureDeStyle[] = [
    ...
    new FigureDeStyle("Métaphore", "d'analogie", "remplace ce dont on parle par une autre expression à prendre au sens figuré", "le chemin de la réussite / rendre les armes"),
    new FigureDeStyle("Personnification", "d'analogie", "attribue à la chose dont on parle des qualités, des capacités, qui n'existent que chez une personne", "la flamme de la bougie dansait"),

    new FigureDeStyle("Métonymie", "de substitution", "remplace ce dont on parle par une autre chose, liée logiquement avec cette chose", "boire un verre et manger toute son assiette / aller au bureau"),
    new FigureDeStyle("Synecdoque", "de substitution", "forme de métonymie qui remplace ce dont on parle par une partie de cette chose", "faire de la voile / demander la main de quelqu'un"),
    ...
    new FigureDeStyle("Allégorie", "de substitution", "remplace une notion, une idée, par une représentation visuelle de cette idée", "la Grande Faucheuse - le sablier du Temps - l'épée de la justice - "),
 
    new FigureDeStyle("Antithèse", "d'opposition", "présente ensemble deux éléments opposés afin de mettre en valeur le contraste que forme leur association"),
    new FigureDeStyle("Oxymore", "d'opposition", "associe dans une expression deux éléments qui ne peuvent pas aller ensemble et qui se contredisent logiquement"),
    new FigureDeStyle("Chiasme", "d'opposition", "associe deux groupes de deux éléments en inversant l'ordre des éléments du second groupe", "un homme(a) riche(b) et une jolie(b) femme(a)"),
    new FigureDeStyle("Antiphrase", "d'opposition", "consiste à dire le contraire de ce que l'on pense pour se moquer", "Ah ! C'est malin ! Quelle brillante  idée ! Tu as trouvé ça tout seul ?"),

    new FigureDeStyle("Anaphore", "d'insistance", "Un inconnu est entré chez moi. Un inconnu a fouillé ma maison. Un inconnu a ouvert mes tiroirs. Un inconnu a saccagé toutes mes affaires !"),
    new FigureDeStyle("Parallélisme", "d'insistance", "Je mène une petite vie tranquille dans un bel endroit isolé / une élégante nappe de tissu, de splendides assiettes de porcelaine, de magnifiques couverts d'argent"),
