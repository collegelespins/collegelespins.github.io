...
const cours = [
    ...
    new Cours("Le texte poétique", "Comment faire l'étude d'une poésie ?"),
    new Cours("Le texte théâtral", "Comment faire l'étude d'une scène ?"),
    new Cours("Le texte narratif", "Comment faire l'étude d'un récit ?"),
    new Cours("Le texte d'idées", "Comment faire l'étude d'un texte argumentatif ?"),
